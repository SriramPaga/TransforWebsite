...
function ComingSoon() {
  return (
    <div>
      <div className="w-full h-screen bg-gradient-to-r from-darkTangerine to-CustomdarkCyan">
        <div class="w-full h-screen flex flex-col items-center justify-between bg-RoseWhite bg-opacity-70 py-8">
          <div class="flex-1 flex flex-col items-center justify-center">
            <div class="bg-white bg-opacity-10 px-4 py-2 rounded-xl flex items-center justify-center text-cyan-100 space-x-2 lg:space-x-4"></div>
            <h1 class="text-6xl lg:text-7xl xl:text-8xl text-white tracking-wider font-bold font-serif mt-12 text-center">
              Coming Soon
            </h1>
